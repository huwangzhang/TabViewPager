...
public class ViewPagerIndicator extends LinearLayout {
    ...
    // 三角的最大宽度
    private final int DIMENSION_TRIANGLE_WIDTH_MAX = (int) (getScreenWidth()/3 * RADIO);
...
//        canvas.translate(mInitmTranslationX + mTranslationX, getHeight() + title_bar_bg_one_row);
     ...
     * @param pos
     */
    private void highLightTabText(int pos) {
        resetTabTextColor();
